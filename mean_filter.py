class MeanFilter:
    ...
    def __init__(self, kernel_size=3):
        ...
        self.radius = kernel_size // 2  # ile pikseli na boki od środka
    ...
    def apply(self, data):
        ...
        for y in range(h):
            for x in range(w):
                new_data[y][x] = self._mean_for_pixel(data, x, y)
    ...
    def _mean_for_pixel(self, data, x, y):
        neighbors = self._get_neighbors(data, x, y)
        return self._compute_mean(neighbors)
